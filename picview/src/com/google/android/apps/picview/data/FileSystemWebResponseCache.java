...
/**
 * A cache that stores web responses on the device storage. It a
...
public class FileSystemWebResponseCache {
	 ...
	 * @return the response or <code>null</code>, if the database does not
	 *         contain a response for the given URL
	 */
